            ...
            <div data-aos="fade-right" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
                <div className="hero  bg-base-200">
                    <div className="hero-content gap-6 flex-col lg:flex-row-reverse">
                        <img src="https://i.ibb.co/HFvwZSD/9175292-6520-1.jpg" className="md:max-w-lg md:max-h-[500px] rounded-full shadow-2xl" />
                        <div>
                            ...
                            <div className="flex justify-center">
                                <Link to='/contact'>
                                    <button className="btn bg-[#005d5f] text-[#dfe33d] ">Get in Touch</button>
            ...
            <div data-aos="fade-left" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
                <div className="hero min-h-screen bg-gray-300">
                    <div className="hero-content flex-col lg:flex-row">
                        <img src="https://i.ibb.co/CVG7ch5/1321x881ai-02.webp" className="md:max-w-lg rounded-lg shadow-2xl" />
                        <div>

    ...
    return (
        <div className="bg-[#dfe36f]">
            <div data-aos="fade-right" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
                <div className="md:flex justify-around mt-6 pb-4 px-8 py-4 ">
            ...
            <div className="grid gap-4 p-4 md:grid-cols-4 mt-4 text-center">
                ...
                <div data-aos="zoom-in" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
                    <div className="col-span-1 bg-white shadow-lg rounded-lg">
                        <img src="https://i.ibb.co/mC5GVFS/Team-memeber-01.png" className="w-32 rounded-full mx-auto my-5" alt="" />
                ...
                <div data-aos="zoom-in" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
                    <div className="col-span-1 bg-white shadow-lg rounded-lg">
                        <img src="https://i.ibb.co/7CMvDTx/images.jpg" className="w-32 rounded-full mx-auto my-5" alt="" />
